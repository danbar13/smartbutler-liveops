...
- **עמידה ביעד**: תקן מוגדר מראש (`Standard`), חישוב עמידה ביעד (`%Success`).""",
        ...
        "tab1_active_card_title": "✅ פרטי הדוח נקלטו בהצלחה והם מוכנים לתצוגה",
        "tab1_active_card_desc": "הנתונים של דוח #{id} ({site}, {period}) מעודכנים כעת במערכת. באפשרותך לעבור ישירות לכרטיסיות הבאות לצפייה בניתוח המלא:",
        "tab1_btn_goto_tab2": "📋 תדריך להנהלה — ישיבת בוקר ➜",
        "tab1_btn_goto_tab3": "🔍 תובנות עיקריות ומשמעותיות ➜",
        "tab1_btn_goto_tab4": "📊 פירוט לפי מודולים ומחלקות ➜",
        "tab1_quick_select": "⚡ בחר דוח להצגה מתוך המאגר:",
        "tab1_toast_loaded": "✅ דוח #{id} ({site}) נטען בהצלחה! הנתונים מעודכנים בכל הכרטיסיות.",
...
- **SLA Adherence**: Preset SLA standard (`Standard`), compliance calculation (`%Success`).""",
        ...
        "tab1_active_card_title": "✅ Report Data Loaded & Ready for Analysis",
        "tab1_active_card_desc": "Data for Report #{id} ({site}, {period}) is updated in the system. You can navigate directly to the following tabs to view the complete analysis:",
        "tab1_btn_goto_tab2": "📋 Executive Briefing — Morning Standup ➜",
        "tab1_btn_goto_tab3": "🔍 Key Strategic Insights ➜",
        "tab1_btn_goto_tab4": "📊 Module & Department Breakdown ➜",
        "tab1_quick_select": "⚡ Select a report to display from archive:",
        "tab1_toast_loaded": "✅ Report #{id} ({site}) loaded successfully! Data updated across all tabs.",
